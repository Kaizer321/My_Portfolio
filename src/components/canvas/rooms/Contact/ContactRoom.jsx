    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/muhammad-umer-1bb52326b', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/Kaizer321', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* FACEBOOK */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.open('mailto:cadetumar632@gamil.com', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM */}
